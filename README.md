- [x] разделение исходного проекта на 2 части
- [x] добавить запуск siri shortcut в фоновом режиме за 10 секунд до конца
- [ ] потерялся звук клавиатуры - восстановить
- [ ] подогнать часы под экран 6.25' 560x720 144.18mm x 66.60mm
